...
# メタデータのダミー
PRODUCTS = [
    "疑似果肉入りジャム", "低糖質クッキー", "高プロテインドリンク", "米粉パン", "ヴィーガンマヨネーズ", "バター","フライドチキン","フライドポテト","フライドキャベツ","フライドレタス","フライドブロッコリー","フライドキュウリ","フライドカブ",
    "カシューナッツパウダー", "アサイーボウル", "ピータン", "カロリーメイト", "低糖質ショートケーキ", "ポテトチップス",
    "ラーメン", "うどん", "ハンバーグ", "大豆ミート", "チョコレート", "キャベツチョコレート", "レタス", "ブロッコリー", "キュウリ", "カブ"
    ]
ISSUES = [
    "粘度不足", "風味の劣化", "分離の発生", "コストダウン要求", "新規開発", "甘味",
    "触感改善", "加熱処理", "酸味抑制", "つや出し、色調", "ライフ延長", "ヴィーガン",
    "低糖質", "高プロテイン対応", "低カロリー", "低脂肪", "香り", "乳化"
    ]
INGREDIENTS = [
    "グラニュー糖", "ヒートゾル", "メチルセルロース", "HPMC", "パイナップル濃縮果汁", "ユニペクチン", "ペクチンLM", 
    "クエン酸", "クエン酸ナトリウム", "乳酸カルシウム", "難消化性デキストリン",
    "脱脂粉乳", "植物油脂", "Peptan-F-2000-LD", "香料", "アスコルビン酸","ペクチンUF、ファイバー", "ペクチン", "UNIPECTINE", "UF-200", "UF-250", "UF-300", "UF-350", "UF-400", "UF-450", "UF-500"
]
CUSTOMERS = ["キユーピー", "XYZ飲料", "スーパーマーケットチェーンA", "コンビニエンスストアB","CCC食品", "山崎パン", "セブンイレブン",
    "山パン", "丸ケミ", "ファミリーマート", "コンビニ", "ドラッグストア", "マルチパン", "マルチケミ", "マルチ食品", "カーギル", "Cargill"
    , "ロッテ", "メルカリ", "ドトール", "ロヂャース", "トライアル", "ロヂャース", "トライアル", "ロヂャース", "トライアル", "ロヂャース", "トライアル", "ロヂャース", "トライアル", "ロヂャース", "トライアル", "ロヂャース", "トライアル"]
AUTHORS = ["山田太郎", "鈴木一郎", "佐藤花子", "高橋次郎", "山田太一", "門間", "田村和也", "山本六郎", "山口八郎"]
